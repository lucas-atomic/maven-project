pipeline {
    ...
    parameters {
          string(name: 'Jenkins', defaultValue: '3-86-84-170.compute-1.amazonaws.com', description: 'Staging Serve')
          string(name: 'JenkinsDev', defaultValue: '3-88-207-178.compute-1.amazonaws.com', description: 'Production Server')
    }
